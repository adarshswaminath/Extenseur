  ...
  return (
    <div>
      <div className="py-12">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-4">
          <div class="flex-1">
            <img src={Image} alt="About us" class="w-full h-64 lg:h-auto border-8 border-tealblue object-cover" />
          </div>
          <div class="flex-1 lg:mb-0">
            <p class="mt-4 text-lg leading-relaxed text-golden">
