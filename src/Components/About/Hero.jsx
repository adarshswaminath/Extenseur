...
function Hero() {
  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex gap-4 flex-col lg:flex-row items-center justify-center lg:justify-between">
    <div className="flex-1">
      <img src={Image} alt="About us" className="w-full border-8 border-tealblue object-cover h-64 lg:h-auto" />
    </div>
    <div className="flex-1 mb-6 lg:mb-0">
      <p className="mt-4 text-lg text-golden leading-relaxed">
