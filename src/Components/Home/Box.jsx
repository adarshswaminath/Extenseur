        ...
        <div className=''>
            <div className="grid lg:flex ">
                ...
                <div className="w-full p-20 bg-white lg:w-1/2 ">
                    <h1 className="text-center spcl-font max-w-2xl mb-6 text-4xl tracking-tight leading-none">
                        Get Free Consultation
                    </h1>
                    <p className="mb-6 text-gray-500">Get in touch with us for all your studies,
                        employment, visa & Immigration requirements. We are happy to assist you.</p>
                    <form>
                ...
                {/* white box ends */}
                {/* golden box starts */}
                <div className="p-20 w-full bg-golden lg:w-1/2 ">
                    <div className="quick-contact">
                        <h1 className="text-4xl mb-8 text-center">Quick Contact</h1>
                        <p className="text-gray-600 mb-8">
                            We are delighted to assist you with your qualifications, study options, career plans, potential immigration opportunities, and address any questions or concerns you may have.
                        </p>
