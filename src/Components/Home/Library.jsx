    ...
    <section className="bg-background">
      <div className="grid max-w-screen-xl grid-cols-12 gap-8 px-4 py-8 mx-auto lg:gap-16 lg:py-16">
        <div className="col-span-12 lg:col-span-7 self-center">
          ...
          <a href="#" className="inline-flex items-center justify-center w-96 px-5 py-3 mb-2 font-medium text-white bg-golden rounded-full text-center text-base hover:bg-golden-darker focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-golden">
